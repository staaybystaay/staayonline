...
const values = [
  {
    ...
    body: 'Every seam, silhouette, and fabric choice is deliberate. We do not make filler pieces. Everything earns its place in your wardrobe and in your life.',
  },
  {
    n: '02',
    title: 'Made for African Women',
    body: 'Not adapted, not translated — designed from scratch for the bodies, lifestyles, and boldness of African women. You are not an afterthought.',
  },
  {
    n: '03',
    title: 'Softness is Strength',
    body: 'We build pieces that honour femininity in all its forms. You never have to choose between elegance and confidence — STAAY holds both.',
  },
  {
    n: '04',
    title: 'Community First',
    body: 'Our customers are not buyers. They are the first people we think about when we sketch, cut, and finish. STAAY is built by community, for community.',
  },
]
...
/* ══════════════════════════════════════════
   HERO — fixed desktop image, mobile unchanged
══════════════════════════════════════════ */
function Hero() {
    ...
    >
        ...
        <img
          ...
          onError={e => {
            ...
            e.currentTarget.parentElement.style.background =
              'linear-gradient(160deg,#3a2a10,#1a1409)'
          }}
        />
      ...
      >
        <div>
          ...
          >
            A Ghanaian womenswear brand rooted in intention, craftsmanship, and
            grace — built by a woman who understands what it means to come into
            your own.
          </p>
        </div>
  ...
  return (
    ...
    >
      <FadeUp style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        >
          "Women were never meant to shrink. They were meant to bloom, to
          evolve, and most importantly —{' '}
          <span style={{ color: T.gold, fontStyle: 'normal' }}>
            to STAAY true to themselves.
          </span>
          "
        </p>
      </FadeUp>
    ...
    >
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: smallMobile ? '1fr' : '1fr 1fr',
      ...
      >
        <FadeUp
          style={{
            ...
            borderRight: !mobile ? `1px solid ${T.line}` : 'none',
          }}
        >
          ...
          <p style={{ fontFamily: SANS, fontSize: 14, fontWeight: 300, color: T.mid, lineHeight: 1.7, marginBottom: 32, maxWidth: 300 }}>
            Every piece in the SS 2025 collection is available now. Designed
            for the woman ready to show up fully as herself.
          </p>
