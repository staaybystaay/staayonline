    ...
    <div
      ...
      <motion.div
        ...
        <button
          ...
          onMouseLeave={e => { e.currentTarget.style.background = 'rgba(128,128,128,0.15)'; e.currentTarget.style.color = DK }}>
          ✕
        </button>
        <img src="/pop-hero.jpg" alt="Promo" style={{ width: '100%', display: 'block' }} />
