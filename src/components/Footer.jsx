...
function Newsletter() {
  ...
  function handleMouseLeaveBtn(e) {
  ...
  return (
    <div style={{ maxWidth: '440px' }}>
      ...
      <p style={{
        ...
        New drops, exclusive offers, editorial content. Delivered first.
      </p>
...
export default function Footer() {
  ...
  function makeHoverIn(e) {
    e.currentTarget.style.borderColor = 'var(--accent)'
    e.currentTarget.style.color = 'var(--accent)'
    e.currentTarget.style.background = 'var(--accent-soft)'
  }

  function makeHoverOut(e) {
  ...
  function topBtnHoverIn(e) {
    e.currentTarget.style.color = 'var(--accent)'
  }

  function topBtnHoverOut(e) {
    e.currentTarget.style.color = 'var(--text-muted)'
  }
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '72px 80px 48px' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
                ...
                rel="noreferrer"
                style={socialStyle}
                onMouseEnter={makeHoverIn}
                onMouseLeave={makeHoverOut}
              >
                <InstagramIcon />
              </a>
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={topBtnHoverIn}
            onMouseLeave={topBtnHoverOut}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: '6px',
